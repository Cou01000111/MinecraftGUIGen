  ...
  var FloatingActionButton = (function (_Component14) {
    ...
    function FloatingActionButton(el, options) {
      ...
      var _this48 = _possibleConstructorReturn(
        this,
        (FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton)).call(
          this,
  ...
  var CharacterCounter = (function (_Component17) {
    ...
    function CharacterCounter(el, options) {
      ...
      var _this61 = _possibleConstructorReturn(
        this,
        (CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter)).call(
          this,
          CharacterCounter,
          el,
          options
            ...
            if (!this.el.disabled) {
              ...
              dropdownOptions.onOpenEnd = function (el) {
                ...
                if (_this71.dropdown.isScrollable && selectedOption.length) {
                  var scrollOffset =
                    selectedOption[0].getBoundingClientRect().top - _this71.dropdownOptions.getBoundingClientRect().top; // scroll to selected option
